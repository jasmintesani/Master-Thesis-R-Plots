...
data <-
  read.csv(
    'C:\\Users/Filippo/Desktop/October exp/Evo/Nexabiome_CocktailCoated_BioChip_OD595_bead&wells_MScThesisTesani2025/Nexabiome_CocktailCoated_BioChip_OD595_bead&wells_MScThesisTesani2025.csv'
  )
...
unique_conditions <-
  c("d23cbw", "d23ncbw", "d43cbw", "d43ncbw", "d86cbw", "d86ncbw")
colors <-
...
labels <- c(
  "Wells surrounding coated beads with FPS-D23",
  "Wells surrounding noncoated beads with FPS-D23",
  "Wells surrounding coated beads with FPS-D43",
  "Wells surrounding noncoated beads with FPS-D43",
  "Wells surrounding coated beads with FPS-D86",
  "Wells surrounding noncoated beads with FPS-D86"
)
