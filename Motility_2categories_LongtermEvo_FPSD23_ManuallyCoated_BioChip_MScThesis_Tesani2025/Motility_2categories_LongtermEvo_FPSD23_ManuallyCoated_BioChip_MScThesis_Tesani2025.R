...
data <-
  read.csv(
    'C:\\Users/jasmi/Desktop/October exp/Evo/Motility_2categories_LongtermEvo_FPSD23_ManuallyCoated_BioChip_MScThesis_Tesani2025/Motility_2categories_LongtermEvo_FPSD23_ManuallyCoated_BioChip_MScThesis_Tesani2025.csv'
  )
