...
data <-
  read.csv(
    'C:\\Users/jasmi/Desktop/October exp/Evo/PFUperBead_Shortterm_10dayEvo_FPSVD22ManualCoated_MScThesisTesani2025/PFUperBead_Shortterm_10dayEvo_FPSVD22ManualCoated_MScThesisTesani2025.csv'
  )
