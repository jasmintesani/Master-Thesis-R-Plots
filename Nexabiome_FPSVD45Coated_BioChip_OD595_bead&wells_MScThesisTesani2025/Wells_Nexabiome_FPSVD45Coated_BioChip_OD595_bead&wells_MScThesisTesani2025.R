...
data <-
  read.csv(
    'C:\\Users/jasmi/Desktop/October exp/Evo/Nexabiome_FPSVD45Coated_BioChip_OD595_bead&wells_MScThesisTesani2025/Nexabiome_FPSVD45Coated_BioChip_OD595_bead&wells_MScThesisTesani2025.csv'
  )
...
plot <- ggplot(summary_data_long,
  ...
  labs(x = "\nTime (days)",
       y = "OD at 590 nm\n",
       fill = "Condition",
       title = "Biofilm on wells surrounding the beads coated with phage FPSV-D45") +
  theme_minimal() +
  theme(
